  ...
  while (true) {
    ...
    for (const b of data) {
      map.set(b.book_code, {
        ...
        canon_order: b.canon_order ?? null
      });
    }
...
async function main() {
  ...
  // Pass 1: compute I_raw distribution for P95_I
  ...
  console.log('\nNOTE: If V1 metrics were only computed for Jude, most sections will have base=0 and importance=0.');
}
