...
comment on function public.obs_skip_broken_assessment_question(
  ...
  'Logs a broken assessment question, marks it skipped without scoring, and keeps the attempt target stable so learners still see the intended scored-question count.';
