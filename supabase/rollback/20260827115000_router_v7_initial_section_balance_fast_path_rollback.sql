...
begin
  ...
  where backup.backup_tag = '20260827115000_router_v7_initial_section_balance_fast_path'
  ...
  if v_definition is null then
    raise exception using
      errcode = 'P0001',
      message = 'Missing backup for 20260827115000_router_v7_initial_section_balance_fast_path rollback.';
  end if;
