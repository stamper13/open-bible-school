...
sql_file="$repo_root/supabase/verify/launch_assessment_router_profile_simulation.sql"
report_dir="$repo_root/supabase/review"
report_file="$report_dir/launch_assessment_router_profile_simulation_$(date -u +%Y%m%d%H%M%S).txt"
