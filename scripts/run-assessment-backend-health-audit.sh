...
sql_file="$repo_root/supabase/diagnostics/assessment_backend_quality_audit.sql"
report_dir="$repo_root/supabase/review"
report_file="$report_dir/assessment_backend_quality_audit_$(date -u +%Y%m%d%H%M%S).txt"
