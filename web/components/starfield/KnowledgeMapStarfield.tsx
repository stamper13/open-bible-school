...
import { createSeededRandom, drawStreak, SHOOTING_PALETTES } from "@/lib/skyStreak";
import type { KnowledgeMapVariantProps } from "./types";
...
export default function KnowledgeMapStarfield({ motionPaused = false }: KnowledgeMapVariantProps) {
