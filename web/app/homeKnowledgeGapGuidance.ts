// The knowledge-gap study guidance content: what to practice, and which
// resources to link, for each skill dimension — with book- and unit-level
// overrides for cases where the generic dimension advice doesn't fit.
// This is content, not logic (most of this file is copy), so it's kept
// separate from homeHelpers.ts's actual functions. Split out of
// homeHelpers.ts during a file-size cleanup; no behavior change.

import type { KnowledgeGapGuidance, KnowledgeGapGuidanceOverride } from "./homeTypes";
